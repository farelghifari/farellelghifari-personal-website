...
export default function CategoryPage({ params }: { params: Promise<{ category: string }> }) {
  ...
  const handleCategoryToggle = (groupName: string) => {
    ...
    const willOpen = !expandedCategories[groupName]

    const newState: Record<string, boolean> = {}

    Object.keys(groupedItems).forEach(group => {
      newState[group] = group === groupName && willOpen
    })
            ...
            {category === 'certification' && Object.keys(groupedItems).length > 0 ? (
              ...
              Object.entries(groupedItems).map(([groupName, groupItems]) => (
                ...
                <div
                  ...
                  className="space-y-4 first:pt-0"
                >
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className={cn(
                          ...
                          !expandedCategories[groupName] && "-rotate-90"
                        )}>
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <span className="text-sm text-foreground/60">
                          {groupItems?.length || 0} certification
                  ...
                  {expandedCategories[groupName] && (
                    ...
                    <div className="space-y-4">
                      ...
                      {groupItems.map((item: any, index: number) => {
                        ...
                        const itemId = item.id ?? `cert-${index}`
